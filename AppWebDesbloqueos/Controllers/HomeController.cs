...
namespace AppWebDesbloqueos.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            return Unauthorized();  // Retorna un código de error si el usuario no tiene permisos 
        }
